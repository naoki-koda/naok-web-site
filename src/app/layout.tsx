...
export const metadata: Metadata = {
  ...
  description:
    "名古屋市を拠点とするREEWA WEBは、中小企業・個人事業主のためのSEOに強い高速なホームページ制作・運用を提供。美容サロン・飲食店・職人・クリニックなど業種別サイト構築から補助金活用、制作費の相場診断、AIツール導入、フリーランス協業までトータルで支援します。",
  ...
  openGraph: {
    ...
    description:
      "愛知・名古屋で成果につながるWebサイト制作。制作費の相場や1ページ単価、補助金・助成金の活用、AIツールや自作支援、業種別（美容・サロン・職人・飲食店・クリニック等）の戦略、フリーランス協業まで多角的にサポートし、高速表示とSEOに強いNext.jsサイトでお問い合わせ獲得を支援します。",
